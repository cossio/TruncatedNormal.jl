...
"""
function sample_truncated_bivariate_gaussian(Sig::RealMatrix, lb::RealVector, ub::RealVector, N::Integer)
    #=
...
conditional on lb ≤ X ≤ ub. Accepts infinite lb, ub.
"""
function sample_truncated_bivariate_gaussian(μ::RealVector, Sig::RealMatrix, lb::RealVector, ub::RealVector, N::Integer)
